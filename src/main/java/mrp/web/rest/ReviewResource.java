...
public class ReviewResource {
    ...
    @Timed
    public ResponseEntity<List<Review>> getAllReviewsByMovie(Pageable pageable, @PathVariable Long id) {
        Page<Review> page = reviewService.findAllByMovie(pageable, id);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/reviews");
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }
