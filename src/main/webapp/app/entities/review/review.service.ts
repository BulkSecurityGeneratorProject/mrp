...
export class ReviewService {
    ...
    queryByMovie(movieID: number, req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IReview[]>(`${this.resourceUrl}/movie/${movieID}`, { params: options, observe: 'response' });
    }
